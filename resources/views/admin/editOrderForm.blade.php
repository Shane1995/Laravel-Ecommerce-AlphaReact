...
<div class="table-responsive">
    ...
    <form action="{{route('adminUpdateOrder',['order_id' => $order->order_id ])}} " method="post">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="date" id="date" placeholder="Date" value="{{$order->date}}"
                required>
        </div>
        <div class="form-group">
            <label for="del_date">Delivery Date</label>
            <input type="date" class="form-control" name="del_date" id="del_date" placeholder="delivery date"
                value="{{$order->del_date}}" required>
        </div>
